		...
		<div class="col-md-4 offset-md-4">
			<div class="card">
				<div class="card-body text-center">
					...
					<h5 class="text-sucess">${mensagem_sucesso}</h5>
					...
					<form action="criar-usuario-post" method="post" id="formCadastro"
						...
						<div class="mb-2">
							<label>Nome do usuário:</label> <input type="text" id="nome"
								name="nome" class="form-control"
								placeholder="Digite seu nome aqui" />
						</div>

						<div class="mb-2">
							<label>Email do usuário:</label> <input type="text" id="email"
						...
						<div class="mb-2 d-grid">
							<a href="/javaContasMvc/" class="btn btn-light"> Voltar para
								a página inicial. </a>
						</div>
	...
	<script>
		$(document).ready(function() {
			...
			$("#formCadastro").validate({
				...
				messages: {
					"senha": {
						pattern: "Informe pelo menos 1 letra maiúscula, 1 número, 1 símbolo e pelo menos 8 caracteres."
					}
				}
			})
		});
